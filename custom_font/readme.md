...
How to install the free custom font section (link below)
How to apply fonts to specific elements (H1, H2, menus, links, and more)
How to enable/disable fonts instantly with a simple toggle

Works on ANY Shopify theme—Dawn, Horizon, Atelier, Ritual, and more

Blog: https://websensepro.com/blog/how-to-add-custom-font-in-shopify/
